...
public class BasicAuthInterceptor extends AbstractPhaseInterceptor<Message> {
    ...
    public void handleMessage(Message message) throws Fault {
        ...
        if (policy == null || policy.getUserName() == null || policy.getPassword() == null) {
            sendErrorMessage(message, HttpURLConnection.HTTP_UNAUTHORIZED);
            return;
        }
    ...
    private void sendErrorMessage(Message message, int responseCode) {
    ...
    private Message getOutMessage(Message inMessage) {
        ...
        if (outMessage == null) {
            ...
            outMessage = ((Binding) endpoint.getBinding()).createMessage();
